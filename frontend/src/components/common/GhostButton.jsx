const CLS =
  ...
  'bg-surface text-[rgba(14,165,233,0.95)] border border-[rgba(14,165,233,0.95)] ' +
  'shadow-[0_2px_8px_rgba(10,49,114,0.3)] ' +
  'hover:bg-[rgba(14,165,233,0.95)] hover:text-on-dark hover:shadow-[0_4px_16px_rgba(0,0,0,0.5)] ' +
