...
describe('intégration statique des préférences visuelles', () => {
  ...
  it('intègre le sélecteur dans le flux du header sans portail ni chevauchement', () => {
    ...
    expect(settings).toContain('data-header-settings-placement');
    expect(settings).toContain('registerSettingsPanel');
    expect(settings).toContain("settingsPlacement !== 'row'");
    ...
    expect(shell).toContain('HeaderSettingsContext');
    expect(shell).toContain('data-header-settings-row="true"');
