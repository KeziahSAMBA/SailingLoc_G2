...
const hearts = page.locator('button[aria-label="Ajouter aux favoris"], button[aria-label="Retirer des favoris"]');
...
await page.screenshot({ path: 'category-favorite.png', clip: { x: 0, y: Math.max(0, (box?.y ?? 0) - 250), width: 700, height: 500 } });
