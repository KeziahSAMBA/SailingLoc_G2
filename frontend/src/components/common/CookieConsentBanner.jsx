...
function PreferencesPanel({ onClose }) {
  ...
  return (
    <div
      className="fixed inset-0 z-[70] flex items-end justify-center overflow-hidden bg-overlay/50 p-2 sm:items-center sm:p-4"
      onClick={onClose}
    >
      <div
        role="dialog"
      ...
      >
        ...
        <div className="mb-3 flex shrink-0 items-start justify-between gap-4">
          <h2 id="cookie-prefs-title" className="text-lg font-semibold text-content">
