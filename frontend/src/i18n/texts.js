...
export const TEXTS = {
  ...
  carrousel: {
    ...
    sections: {
      ...
      favoritesLink: { fr: 'Voir mes annonces favorites', en: 'View my favorite listings' },
      favoritesEmpty: {
        fr: "Aucune annonce en favoris pour l'instant",
      ...
      favoritesLoginCta: { fr: 'Se connecter', en: 'Log in' },
      ...
      coupDeCoeur: { fr: 'Nos coups de cœur', en: 'Our top picks' },
      coupDeCoeurLink: { fr: 'Voir la sélection', en: 'See the selection' },
