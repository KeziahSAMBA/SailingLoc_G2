  ...
  return (
    <main className="mx-auto max-w-6xl p-6">
      <header className="mb-8">
        ...
        <p className="mt-2 text-slate-600">Gestion des annonces, réservations et paiements.</p>
      </header>

      <section className="grid gap-6 md:grid-cols-2">
        {boats.length === 0 ? (
          <div className="rounded-2xl bg-white p-8 shadow-sm">Aucune annonce pour le moment.</div>
        ) : (
