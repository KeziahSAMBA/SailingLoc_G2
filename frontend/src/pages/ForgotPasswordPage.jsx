          ...
          <article className="rounded-2xl border border-glass/20 bg-surface/10 p-8 shadow-2xl backdrop-blur-xl">
            {submitted ? (
              <div role="status" aria-live="polite" className="text-center">
                ...
                <h1 className="text-2xl font-bold text-on-dark">Vérifiez votre boîte mail</h1>
              ...
              <>
                <header className="mb-6 text-center">
                  <h1 id="forgot-title" className="text-2xl font-bold text-on-dark">
                    Mot de passe oublié
                  </h1>
                          ...
                          return (
                            <label
                              ...
                              className={`flex cursor-pointer items-center justify-center gap-2 rounded-lg border px-4 py-2.5 text-sm font-medium transition ${
                                checked
                                  ? 'border-brand bg-action/25 text-on-dark'
                                  : 'border-glass/30 bg-surface/10 text-on-dark/70 hover:bg-surface/20'
                              }`}
                            >
                              <input
                                type="radio"
                ...
                <footer className="mt-6 text-center text-sm text-on-dark/70">
                  <Link
                    ...
                    className={`rounded font-semibold text-brand hover:underline ${FOCUS_RING}`}
                  >
